...
prepaste_upscale_max: float = 4.0  # max upscale factor for pre-paste Lanczos (1.0-8.0)
...
# --- Affine Scale Smoothing ---
scale_smoothing: bool = False  # EMA-smooth the affine scale to prevent expression-driven face resizing
scale_smoothing_alpha: float = 0.3  # EMA weight for current frame (lower = more stable, 0.1-0.5 recommended)
