...
class TestFindBinary:
    ...
    def test_finds_in_models_dir(self, tmp_path):
        ...
        with (
            patch("modules.rife_interpolation.shutil.which", return_value=None),
...
class TestFindModelDir:
    ...
    def test_finds_in_models_dir(self, tmp_path):
        ...
        with (
            patch("modules.rife_interpolation.RIFE_DIR", "/nonexistent"),
...
class TestBackendDetection:
    ...
    def test_cli_fallback_when_no_native(self):
        with (
            patch("modules.rife_interpolation.has_native_binding", return_value=False),
            patch("modules.rife_interpolation.find_binary", return_value="/usr/bin/rife"),
        ):
...
class TestPreCheck:
    ...
    def test_passes_with_cli_backend_and_model(self):
        ...
        with (
            patch("modules.rife_interpolation._get_backend", return_value="cli"),
...
class TestInterpolateFramesDispatch:
    def test_dispatches_to_native(self, tmp_path):
        ...
        with (
            patch("modules.rife_interpolation._get_backend", return_value="native"),
